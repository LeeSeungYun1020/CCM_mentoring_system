...
검색만으로는 완전히 해결되지 않는 코드와 수업에 관한 질문들...  
어쩌면 같이 수업을 듣는 친구들, 조교님, 교수님이 더 잘 알지 않을까?  
특정 주제에 대해 서로 질문하고 답변하는 의견을 주고받으며 성장하는 부산대판 스택 오버플로우를 목표로 한다.  

<img alt="메인 화면" src="./report/main.png" width="48%"/> <img alt="게시판" src="./report/board.png" width="48%"/>
